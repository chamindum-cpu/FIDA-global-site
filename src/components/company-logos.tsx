  ...
  return (
    <section className="py-32 relative overflow-hidden bg-black">
      ...
      <div className="mt-10 flex flex-col gap-8 opacity-40 hover:opacity-80 transition-opacity duration-1000">
        <TickerRow items={row1} speed={30} direction="left" fontClass={spaceGrotesk.className} />
        <TickerRow items={row2} speed={40} direction="right" fontClass={spaceGrotesk.className} />
        <TickerRow items={row3} speed={25} direction="left" fontClass={spaceGrotesk.className} />
      </div>
    </section>
  );
}